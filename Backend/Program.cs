...
<body>
    ...
    <table class='line-items'>
        ...
        <tbody>
            ...
            {(li.DiscountType != Backend.Models.Entities.Branch.DiscountType.None ? $@"
            <tr>
                <td colspan='4' style='font-size: 10px; padding-left: 10px;'>
                    Discount: {(li.DiscountType == Backend.Models.Entities.Branch.DiscountType.Percentage ? $"{li.DiscountValue}% off" : $"${li.DiscountValue:F2} off")}
                </td>
            </tr>" : "")}"))}
        </tbody>
    </table>
    ...
    <div class='footer'>
        ...
        <p>*** {(sale.InvoiceType == Backend.Models.Entities.Branch.InvoiceType.Standard ? "TAX INVOICE" : "SIMPLIFIED INVOICE")} ***</p>
    </div>
</body>
</html>";
