...
public static class InvoiceTemplateSeeder
{
    ...
    public static async Task SeedAsync(BranchDbContext context, Guid adminUserId)
    {
        ...
        var templates = new List<InvoiceTemplate>
        {
            ...
            CreateThermal80mmTemplate(adminUserId, isActive: true), // Default active sales template
            CreateA4Template(adminUserId),

            // Return Templates
            CreateReturnThermal58mmTemplate(adminUserId),
            CreateReturnThermal80mmTemplate(adminUserId, isActive: true), // Default active return template
            CreateReturnA4Template(adminUserId)
        };
    ...
    ""spacing"": {
      ...
      ""padding"": ""8px""
        ...
        return new InvoiceTemplate
        {
            ...
            TemplateType = TemplateType.Sales,
            Schema = schema,
            CreatedBy = createdBy,
  ...
  ""styling"": {
    ...
    /// <summary>
    /// Creates a 58mm thermal return invoice template
    /// </summary>
    private static InvoiceTemplate CreateReturnThermal58mmTemplate(Guid createdBy)
    {
        var schema = @"{
  ""version"": ""1.0"",
  ""paperSize"": ""Thermal58mm"",
  ...
  ""sections"": [
    ...
    },
    {
      ...
      ""config"": {
        ""dynamicTitle"": false,
        ""standardTitle"": ""RETURN INVOICE"",
        ""simplifiedTitle"": ""RETURN INVOICE""
      }
    },
    {
      ""id"": ""customer-info"",
    ...
    },
    {
      ...
      ""config"": {
        ""fields"": [
          { ""key"": ""invoiceNumber"", ""label"": ""Return #"", ""visible"": true },
          { ""key"": ""date"", ""label"": ""Date"", ""visible"": true },
          { ""key"": ""cashier"", ""label"": ""Cashier"", ""visible"": true }
        ]
      }
    ...
    },
    {
      ...
      ""config"": {
        ""fields"": [
          ...
          { ""key"": ""discount"", ""label"": ""Discount"", ""visible"": true },
          { ""key"": ""vatAmount"", ""label"": ""VAT (15%)"", ""visible"": true },
          { ""key"": ""total"", ""label"": ""Refund Amount"", ""visible"": true, ""highlight"": true }
        ]
      }
    },
    {
      ...
      ""config"": {
        ...
        ""showNotes"": true,
        ""notesLabel"": ""Notes"",
        ""notesText"": ""Items returned successfully"",
        ""showPoweredBy"": false,
        ""poweredByText"": """"
      }
    }
  ...
  ""styling"": {
    ...
    ""spacing"": {
      ...
      ""padding"": ""8px""
        ...
        {
            Id = Guid.NewGuid(),
            Name = "Default 58mm Return Receipt",
            Description = "Compact thermal return receipt template for 58mm printers",
            IsActive = false,
            PaperSize = PaperSize.Thermal58mm,
            TemplateType = TemplateType.Return,
            Schema = schema,
            CreatedBy = createdBy,
            CreatedAt = DateTime.UtcNow,
            UpdatedAt = DateTime.UtcNow
    ...
    /// <summary>
    /// Creates an 80mm thermal return invoice template (default for returns)
    /// </summary>
    private static InvoiceTemplate CreateReturnThermal80mmTemplate(Guid createdBy, bool isActive = false)
    {
        var schema = @"{
  ""version"": ""1.0"",
  ""paperSize"": ""Thermal80mm"",
  ...
  ""styling"": {
    ...
    ""spacing"": {
      ...
      ""padding"": ""10px""
        ...
        {
            Id = Guid.NewGuid(),
            Name = "Default 80mm Return Receipt",
            Description = "Standard thermal return receipt template for 80mm printers with full details",
            IsActive = isActive,
            PaperSize = PaperSize.Thermal80mm,
            TemplateType = TemplateType.Return,
            Schema = schema,
    ...
    /// <summary>
    /// Creates an A4 return invoice template
    /// </summary>
    private static InvoiceTemplate CreateReturnA4Template(Guid createdBy)
    {
        var schema = @"{
  ""version"": ""1.0"",
  ""paperSize"": ""A4"",
  ...
  ""sections"": [
    ...
    },
    {
      ...
      ""config"": {
        ...
        ""showNotes"": true,
        ""notesLabel"": ""Notes"",
        ""notesText"": ""Items returned successfully. Refund processed."",
        ""showPoweredBy"": false,
        ""poweredByText"": """"
      }
    }
  ...
  ""styling"": {
    ...
    ""spacing"": {
      ...
      ""padding"": ""15px""
        ...
        {
            Id = Guid.NewGuid(),
            Name = "Default A4 Return Invoice",
            Description = "Professional A4 return invoice template with comprehensive layout",
            IsActive = false,
            PaperSize = PaperSize.A4,
            TemplateType = TemplateType.Return,
            Schema = schema,
