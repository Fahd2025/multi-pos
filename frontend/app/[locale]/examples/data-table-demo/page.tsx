...
export default function DataTableDemoPage() {
  ...
  const columns: DataTableColumn<Product>[] = [
    ...
    },
    {
      ...
      render: (value) => {
        const color =
          value > 50 ? "text-green-600" : value > 20 ? "text-yellow-600" : "text-red-600";
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Generic Data Table Demo</h1>
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            <p className="text-sm text-gray-600">Manage products with full CRUD operations</p>
          </div>
          <button
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ul className="space-y-2 text-sm text-blue-800">
            ...
            <li className="flex items-start">
              ...
              <span>
                Custom hooks (useDataTable, useModal, useConfirmation) manage state efficiently
              </span>
            </li>
            <li className="flex items-start">
              <svg
