...
import { ConfirmationDialog, ModalBottomSheet } from '@/components/modals';
...
export default function UserDetailsPage({
  ...
  const handleSortChange = (config: { key: keyof UserActivityDto | string; direction: 'asc' | 'desc' }) => {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                  user.isHeadOfficeAdmin ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800'
                }`}>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-900">{user.preferredLanguage === 'en' ? 'English' : 'Arabic'}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-900">
                    {user.lastActivityAt ? new Date(user.lastActivityAt).toLocaleString() : 'No activity'}
                  </p>
                </div>
                <div>
