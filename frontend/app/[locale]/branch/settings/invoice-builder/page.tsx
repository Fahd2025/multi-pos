            ...
            <div>
              <label className="flex items-center gap-2 mb-1">
                <input
                  ...
                  className="rounded border-gray-300 dark:border-gray-600"
                />
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Show Order Type</span>
              </label>
            ...
            <div>
              <label className="flex items-center gap-2 mb-1">
                <input
                  ...
                  className="rounded border-gray-300 dark:border-gray-600"
                />
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Show Payment Method</span>
              </label>
            ...
            <div>
              <label className="flex items-center gap-2 mb-1">
                <input
                  ...
                  className="rounded border-gray-300 dark:border-gray-600"
                />
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Show Invoice Barcode</span>
              </label>
