  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <SummaryCard label="Total Revenue" value={`$${report.summary.totalRevenue.toFixed(2)}`} />
        <SummaryCard label="Total Tax" value={`$${report.summary.totalTax.toFixed(2)}`} />
        <SummaryCard
          label="Average Sale"
            ...
            {report.topCustomers.map((customer, idx) => (
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-gray-500">{customer.purchaseCount} purchases</p>
                </div>
                <div className="text-right">
                  <p className="font-semibold text-gray-900 dark:text-gray-100">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <SummaryCard label="Stock Value" value={`$${report.summary.totalStockValue.toFixed(2)}`} />
...
function FinancialReportContent({ report }: { report: FinancialReport }) {
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <SummaryCard label="Total Revenue" value={`$${report.summary.totalRevenue.toFixed(2)}`} />
        <SummaryCard label="Total Expenses" value={`$${report.summary.totalExpenses.toFixed(2)}`} />
        <SummaryCard label="Gross Profit" value={`$${report.summary.grossProfit.toFixed(2)}`} />
        <SummaryCard label="Profit Margin" value={`${report.summary.profitMargin.toFixed(2)}%`} />
      </div>
