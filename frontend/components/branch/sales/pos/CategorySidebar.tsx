    ...
    <button
      ...
      className={`w-full text-left rounded-xl font-medium transition-all touch-manipulation active:scale-95 min-h-[64px] ${
        selectedCategoryId === null
          ...
          : "bg-white dark:bg-gray-800  text-gray-700 hover:bg-gray-100 border-2 border-gray-200"
      ...
      <div className={`flex items-center gap-3 ${isHorizontal ? "justify-center" : ""}`}>
        ...
        {!isHorizontal && (
          <div className="flex-1">
            ...
            <div className="text-xs mt-0.5 opacity-75">View all items</div>
          </div>
        )}
          ...
          {!isHorizontal && (
            <div className="flex-1 min-w-0">
              ...
              {category.productsCount !== undefined && (
                <div className="text-xs mt-0.5 opacity-75">{category.productsCount} items</div>
              )}
            </div>
          )}
