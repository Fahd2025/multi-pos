            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                ...
                >
                  <div className="text-center">
                    <div className="text-2xl mb-1">📱</div>
                    <div className="font-semibold text-sm text-gray-900">Wallet</div>
                  </div>
                </button>
                ...
                >
                  <div className="text-center">
                    <div className="text-2xl mb-1">🏦</div>
                    <div className="font-semibold text-sm text-gray-900">Bank</div>
                  </div>
                </button>
                ...
                >
                  <div className="text-center">
                    <div className="text-2xl mb-1">📝</div>
                    <div className="font-semibold text-sm text-gray-900">Check</div>
                  </div>
                </button>
              </div>
            </div>
