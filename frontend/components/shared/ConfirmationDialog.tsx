        ...
        <div className="flex min-h-full items-center justify-center p-4">
          ...
          >
            ...
            <div className="p-6">
              {/* Icon */}
              <div
                className={`mx-auto flex items-center justify-center h-12 w-12 rounded-full ${styles.iconBg} ${styles.iconColor} mb-4`}
              >
                {styles.icon}
              </div>
              ...
              {!isProcessing && (
                <p className="text-xs text-gray-400 dark:text-gray-500 text-center mt-4">
                  Press{" "}
                  <kbd className="px-2 py-1 bg-gray-100 dark:bg-gray-700 dark:text-gray-300 rounded">
                    Enter
                  </kbd>{" "}
                  to confirm or{" "}
                  <kbd className="px-2 py-1 bg-gray-100 dark:bg-gray-700 dark:text-gray-300 rounded">
